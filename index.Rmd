...
```{r message=FALSE, warning=FALSE}
make_plot(ortho3_shallow, "n", "Records", boundary_atlantic, "log10")
```

```{r message=FALSE, warning=FALSE}
make_plot(ortho3_shallow, "sp", "Species richness", boundary_atlantic, "log10")
```

### Deep occurrences

```{r message=FALSE, warning=FALSE}
make_plot(ortho3_deep, "n", "Records", boundary_atlantic, "log10")
```

```{r message=FALSE, warning=FALSE}
make_plot(ortho3_deep, "sp", "Species richness", boundary_atlantic, "log10")
```
